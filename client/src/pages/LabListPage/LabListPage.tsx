...
export function LabListPage() {
  ...
  const handleRequestJoin = async (labId: string) => {
    try {
      ...
      const response = await axios.post(
        `${process.env.BACKEND_URL}/api/v1/lab/enroll`,
        { labId },
  ...
  const fetchAllLabs = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.BACKEND_URL}/api/v1/lab/all`,
        {
          withCredentials: true,
        }
      );
  ...
  const fetchEnrolledLabs = async () => {
    try {
      ...
      setError(null);
      const response = await axios.get(
        `${process.env.BACKEND_URL}/api/v1/lab/enrolled`,
        { withCredentials: true }
      );
      console.log(response.data);
  ...
  const fetchLabCreatedByUser = async () => {
    try {
      ...
      setError(null);
      const response = await axios.get(
        `${process.env.BACKEND_URL}/api/v1/lab/created`,
        { withCredentials: true }
      );
      console.log(response.data);
  ...
  const handleCreateLab = async (e?: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.BACKEND_URL}/api/v1/lab/create`,
        {
          title,
          description,
          sec,
